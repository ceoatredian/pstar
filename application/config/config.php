...
//$config['base_url'] = 'http://162.144.51.42/~template/uatavmedia/index.php';
...
|--------------------------------------------------------------------------
|
| setting app_id,app_secret,redirect_url,permissions
|
| |
*/
...
define('HTTP_UPLOADS_PATH', $config['base_url'].'uploads/images/');
