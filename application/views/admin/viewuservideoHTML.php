  <!--  page header -->
  <div class="col-lg-12">
    <h1 class="page-header">List User Videos</h1>
  </div>
  <!-- end  page header -->
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <?php echo $this->session->flashdata('msg'); ?>
         ...
         <?php 
        // print_r($userdata); 
		if($userdata==NULL){echo "<br><h2>No Video Found Of This User</h2>";}?>
        ...
        <tr class="gradeA">
           ...
           <source src="<?php echo base_url('assets/images')?>/<?php echo $row['video_path'];?>" >
            ...
            <td>
            <?php if($row['status']=='0' ||$row['status']==NULL){?>
             <a href="<?php echo base_url('admin/user/change_video_staus') ?>/<?php echo $row['id'];?>/<?php echo $row['user_id'].'/0';?>" style="text-decoration:none; color:#4cae4c"> <img src="<?php  echo base_url(); ?>assets/admin/img/active.png"/>  </a>
            <?php }else{ ?>
            <a href="<?php echo base_url('admin/user/change_video_staus') ?>/<?php echo $row['id'];?>/<?php echo $row['user_id'].'/1';?>" 
            style="text-decoration:none; color:#FF0000"> <img src="<?php  echo base_url(); ?>assets/admin/img/inactive.png"/> </a>
            <?php }?>
        &nbsp;    
            <a  href="<?php echo base_url('admin/user/delete_user_video') ?>/<?php echo $row['id'];?>/
