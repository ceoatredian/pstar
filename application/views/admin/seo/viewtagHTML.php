<div class="row">
  <!--  page header -->
  <div class="col-lg-12">
    <h1 class="page-header"> List of Particular Tags/Kewords,Descriptions. </h1>
  </div>
  <!-- end  page header -->
</div>
<div class="row">
<a href="<?php  echo base_url(); ?>admin/seo/showtags"> Back </a>
<div class="col-lg-12">
<!-- Advanced Tables -->
      ...
      //foreach(@$userdata as $key=>$value)
       ...
       ?>
        <tr class="gradeA">
          ...
          <td><?php echo $userdata->tagname;?></td>
          <td><?php echo $userdata->keywords;?></td>
