											...
											<div role="tabpanel" class="tab-pane active" id="photos">
						                       ...
						                       <!-- <a href="<?php echo BASE_URL; ?>user/add_album" class="create-album"><button class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span>Create Album</button></a>-->
												...
												<div class="row">
														...
														<?php echo form_open_multipart("user/save_vedio_album"); ?>
														  ...
														  <div class="form-group">
															...
															<?php echo "<span style='color:red;'>".$this->session->flashdata('msg')."</span>"; ?>	
														  </div>
														  
														
														  <input type="submit" name="save_album" value="Save Video Album " class="btn btn-primary">
														<?php echo form_close(); ?>
												</div>	
											</div>
