...
<div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12">
               ...
               <a href="<?php echo base_url('user/myaccount'); ?>">User-Profile>></a><a href="<?php echo base_url('user/videos'); ?>">
               Videos Album </a>			   			   
			</div>
		</div>
	</div>
			...
			<div class="col-sm-10 post-section">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="photos">
						<h2>Video Albums</h2>
                        <a href="<?php echo BASE_URL; ?>user/add_vedio_album" class="create-album"><button class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span>Create Album</button></a>
                        <p><strong><?php echo $this->session->flashdata('msg'); ?></strong></p>
						<div class="row">
                        <br /><br />
                        
                                   <?php if($vedio_album_data==NULL){
								  echo "<h1 align='center' style='line-height:220px;'>Your Video Album is Empty Please 
								  Create an Album</h1>";
								  }  ?>           
						 <?php foreach ($vedio_album_data as $row): ?>
							<div class="col-sm-4">
								<div class="thumbnail">
									<a href="<?php echo base_url().'user/album_videos/'.$row['id']; ?>"><img src="<?php echo HTTP_IMAGES_PATH.$user_profile->username.'/videos/'.$row['vedio_cover_photo']; ?>" class="img-responsive" style="height:200px;" alt=""></a>
								</div>
                                <p align="center"><?php echo $row['album_title']; ?></p>
                                
                            <a class="btn btn-primary" style="margin-left:2%; " href="<?php echo BASE_URL;?>album/update_valbum/<?php echo $row['id']; ?>" role="button">
                            <span class="glyphicon glyphicon-pencil"></span> Update Album</a>
                            <a class="btn btn-primary"   onClick="return doconfirm();" href="<?php echo BASE_URL;?>album/vedio_delete/<?php echo $row['id']; ?>" role="button"><span class="glyphicon glyphicon-trash"></span> Delete Album</a>
