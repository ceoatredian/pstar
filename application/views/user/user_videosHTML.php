		...
		<div class="row user-profile">
			...
			<div class="col-sm-10 post-section">
				...
				<div class="tab-content">
                    ...
                    <br /><h2>Video Albums</h2>
						              
						 <?php foreach ($vedio_album_data as $row): ?>
							<div class="col-sm-4">
								<div class="thumbnail">
									<a href="<?php echo base_url().'user/user_album_videos/'.$row['id'].'/'.$user_profile->ID ; ?>"><img src="<?php echo HTTP_IMAGES_PATH.$row['vedio_cover_photo']; ?>" class="img-responsive" style="height:200px;" alt=""></a>
								</div>
							...
							<?php endforeach; ?>
                                       ...
                                       </div><div align="center"><?php echo $links; ?> </div> 
									</div>
